...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.Chat.ChatMessage", b =>
                {
                    ...
                    b.Property<string>("ReplyingToUUID")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.Commandment", b =>
                {
                    b.Property<int>("CommandmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<string>("CommandmentCoverUrl")
                        .HasColumnType("longtext");

                    b.Property<string>("CommandmentDescription")
                        .HasColumnType("longtext");

                    b.Property<bool>("CommandmentIsDeleted")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("CommandmentName")
                        .HasColumnType("longtext");

                    b.HasKey("CommandmentId");

                    b.ToTable("Commandments");
                });

            modelBuilder.Entity("GaryPortalAPI.Models.Event", b =>
                {
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.Flag", b =>
                {
                    b.Property<int>("FlagId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<int>("FlagAccessLevel")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.Sticker", b =>
                {
                    b.Property<int>("StickerId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    b.Property<bool>("StickerAdminOnly")
                        .HasColumnType("tinyint(1)");

                    b.Property<bool>("StickerIsDeleted")
                        .HasColumnType("tinyint(1)");

                    b.Property<string>("StickerName")
                        .HasColumnType("longtext");

                    b.Property<bool>("StickerStaffOnly")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.UserFlag", b =>
                {
                    b.Property<int>("FlagId")
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("FlagEnabled")
                        .HasColumnType("tinyint(1)");

                    b.HasKey("FlagId", "UserUUID");
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.Chat.ChatMessage", b =>
                {
                    ...
                    b.HasOne("GaryPortalAPI.Models.Chat.ChatMessage", "ReplyingTo")
                        .WithMany()
                        .HasForeignKey("ReplyingToUUID");
            ...
            modelBuilder.Entity("GaryPortalAPI.Models.UserFlag", b =>
                {
                    b.HasOne("GaryPortalAPI.Models.Flag", "Flag")
                        .WithMany()
